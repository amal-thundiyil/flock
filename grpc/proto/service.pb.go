...
type JobRequest struct {
	...
	CronCommand string `protobuf:"bytes,2,opt,name=cronCommand,proto3" json:"cronCommand,omitempty"`
...
func (x *JobRequest) GetFileContent() string {
	if x != nil {
...
func (x *JobRequest) GetCronCommand() string {
	if x != nil {
		return x.CronCommand
	}
	return ""
}

func (x *JobRequest) GetFileName() string {
	if x != nil {
		return x.FileName
	}
	return ""
...
var file_service_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x6c, 0x0a, 0x0a, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x74, 0x12, 0x20, 0x0a, 0x0b, 0x63, 0x72, 0x6f, 0x6e, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x72, 0x6f, 0x6e, 0x43, 0x6f, 0x6d, 0x6d,
	0x61, 0x6e, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x18,
	...
	0x64, 0x79, 0x32, 0x61, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x42, 0x0a, 0x0a, 0x4a, 0x6f, 0x62, 0x53, 0x65, 0x72, 0x76,
	...
	0x62, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x03, 0x5a, 0x01, 0x2e, 0x62, 0x06,
...
var file_service_proto_depIdxs = []int32{
	...
	2, // 2: proto.JobService.ScheduleJob:input_type -> proto.JobRequest
	1, // 3: proto.AddService.Add:output_type -> proto.Response
	1, // 4: proto.AddService.Multiply:output_type -> proto.Response
	3, // 5: proto.JobService.ScheduleJob:output_type -> proto.JobResponse
