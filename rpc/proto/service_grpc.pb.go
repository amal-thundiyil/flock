...
func (c *jobServiceClient) ScheduleJob(ctx context.Context, in *JobRequest, opts ...grpc.CallOption) (*JobResponse, error) {
	out := new(JobResponse)
	err := c.cc.Invoke(ctx, "/proto.JobService/ScheduleJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type JobServiceServer interface {
	ScheduleJob(context.Context, *JobRequest) (*JobResponse, error)
...
func _JobService_ScheduleJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.JobService/ScheduleJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobServiceServer).ScheduleJob(ctx, req.(*JobRequest))
	}
	return interceptor(ctx, in, info, handler)
}
